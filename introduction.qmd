...
However, an industry which does have plenty of research and is potentially transferable is real estate. The article “5 Ways to Apply Data Science to Real Estate” by Nelson Lau provides a breakdown of how different features in data are applied to make price predictions, perform cluster analysis, and applications which use GIS.
